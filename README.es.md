...
```bash
make -C slim/cpp t830           # enlazado dinámico, 142,352 bytes; necesita libstdc++/libgcc en el dispositivo
make -C slim/cpp t830-static    # 719,144 bytes, NEEDED 0, sin símbolos; no hay que instalar nada allí
```
...
| --- | --- |
| integridad del artefacto | `sha256 1e365e37...` coincide en anfitrión y dispositivo (`NEEDED 0`, sin símbolos) |
