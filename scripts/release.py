...
AUTHOR_MAP = {
    "matt_chang@askey.com": "Matt0080828",  # maintainer identity used by older new_agent commits
    "matttest0080@gmail.com": "matttest0080-prog",  # local fork identity used for the t830-slim agent work
